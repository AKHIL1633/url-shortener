...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-4">
      <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 w-full max-w-md text-center">
        <h1 className="text-4xl font-bold text-white mb-2">⚡ SnapLink</h1>
        <p className="text-purple-300 mb-8">Sign in to manage your links</p>
